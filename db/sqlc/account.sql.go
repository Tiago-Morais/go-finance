...
func (q *Queries) GetAccountGraph(ctx context.Context, arg GetAccountGraphParams) (int64, error) {
	...
	var count_value int64
	err := row.Scan(&count_value)
	return count_value, err
}

const getAccountReport = `-- name: GetAccountReport :one
...
func (q *Queries) GetAccountReport(ctx context.Context, arg GetAccountReportParams) (int64, error) {
	row := q.queryRow(ctx, q.getAccountReportStmt, getAccountReport, arg.UserID, arg.Type)
	var sum_value int64
