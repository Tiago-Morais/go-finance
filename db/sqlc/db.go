...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getAccountReportStmt, err = db.PrepareContext(ctx, getAccountReport); err != nil {
		return nil, fmt.Errorf("error preparing query GetAccountReport: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getAccountReportStmt != nil {
		if cerr := q.getAccountReportStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getAccountReportStmt: %w", cerr)
		}
	}
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getAccountReportStmt: q.getAccountReportStmt,
